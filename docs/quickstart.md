...
virt-install --name="ocp4m1" --vcpus=4 --ram=12288 \
  --disk path=/var/lib/libvirt/images/ocp4-${i}.qcow2,bus=virtio,size=120 \
  --os-variant rhel8.0 --network type=direct,source=enp4s0,source_mode=bridge,model=virtio,mac=52:54:00:e7:9d:67 \
  --boot menu=on --print-xml > ocp4m1.xml
